            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Edit Data Pangkat</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('pimpinan.pangkat.update', $data->id_pangkat) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('nama_pangkat') is-invalid @enderror "
                                            type="text" name="nama_pangkat" value="{{ $data->nama_pangkat }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('golongan') is-invalid @enderror " type="text"
                                            name="golongan" value="{{ $data->golongan }}" placeholder="Nama Golongan">
                                        @error('golongan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('gaji_pokok') is-invalid @enderror "
                                            type="text" name="gaji_pokok" value="{{ $data->gaji_pokok }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group is-invalid">
                                            <input class="form-control @error('potongan') is-invalid @enderror "
                                                type="text" name="potongan" value="{{ $data->potongan }}"
