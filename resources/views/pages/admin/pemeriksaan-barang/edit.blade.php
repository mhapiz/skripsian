        ...
        <div class="row mt-2">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.pemeriksaan-barang.update', $data->id_pemeriksaan_barang) }}"
                            method="POST" id="formPemeriksaanBarang">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-4">
                                                ...
                                                <select name="barang_masuk_id" id="select2"
                                                    ...
                                                    @foreach ($barang_masuk as $bm)
                                                        <option value="{{ $bm->id_barang_masuk }}"
                                                            {{ $data->barang_masuk_id == $bm->id_barang_masuk ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('no_pemeriksaan') is-invalid @enderror "
                                                    type="text" name="no_pemeriksaan"
                                                    value="{{ $data->no_pemeriksaan }}" placeholder="Nomor Pemeriksaan">
                                                ...
                                                <select name="pemeriksa_1" id="pemeriksa1"
                                                    ...
                                                    @foreach ($pegawai as $p)
                                                        <option value="{{ $p->nama_pegawai }}"
                                                            {{ $data->pemeriksa_1 == $p->nama_pegawai ? 'selected' : '' }}>
                                                            {{ $p->nama_pegawai }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <select name="pemeriksa_2" id="pemeriksa2"
                                                    ...
                                                    @foreach ($pegawai as $p)
                                                        <option value="{{ $p->nama_pegawai }}"
                                                            {{ $data->pemeriksa_2 == $p->nama_pegawai ? 'selected' : '' }}>
                                                            {{ $p->nama_pegawai }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <select name="pemeriksa_3" id="pemeriksa3"
                                                    ...
                                                    @foreach ($pegawai as $p)
                                                        <option value="{{ $p->nama_pegawai }}"
                                                            {{ $data->pemeriksa_3 == $p->nama_pegawai ? 'selected' : '' }}>
                                                            {{ $p->nama_pegawai }}
                                                        </option>
                                                    @endforeach
                                                </select>
