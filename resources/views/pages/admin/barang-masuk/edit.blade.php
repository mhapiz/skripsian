        ...
        <div class="row mt-2">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.barang-masuk.update', $data->id_barang_masuk) }}" method="POST"
                            id="formBarangMasuk">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal" id="tanggal" class="form-control"
                                            form="formBarangMasuk" value="{{ $data->tanggal }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <livewire:fetch-option-suplier-live :selected_id="$data->suplier_id" />
                                </div>
                                <div class="col-md-2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_barang[]" id="nama_barang"
                                                    value="{{ App\Models\Barang::find($d->barang_id)->nama_barang }}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_barang[]" id="kode_barang"
                                                    value="{{ App\Models\Barang::find($d->barang_id)->kode_barang }}"
                                                    class="form-control" readonly form="formBarangMasuk">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="jumlah_masuk[]" id="jumlah_masuk"
                                                    value="{{ $d->jumlah_masuk }}" class="form-control"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="harga_satuan[]" id="harga_satuan"
                                                    value="{{ $d->harga_satuan }}" class="form-control"
                                                    form="formBarangMasuk">
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-4">
                                <button class="btn btn-info" type="submit" form="formBarangMasuk">
                                    Perbarui
                                </button>
                            </div>
                        </div>
