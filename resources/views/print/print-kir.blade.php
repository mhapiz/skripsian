    ...
    <div class="header">
        ...
        <table class="w-full table table-pad" style="font-size: .6rem; text-align: start">
            <tr>
                ...
                <td style="width: auto" class="uppercase" colspan="4">Kalimantan Selatan</td>
            </tr>
            <tr>
                <td style="font-weight: 700">Kab./Kota</th>
                <td style="font-weight: 700">:</th>
                <td class="uppercase" colspan="4">Pemerintah Kabupaten Banjar</td>
            </tr>
            <tr>
                <td style="font-weight: 700">Bidang</th>
                <td style="font-weight: 700">:</th>
                <td class="uppercase" colspan="4">Sekretariat Daerah</td>
            </tr>
            <tr>
                <td style="font-weight: 700">Unit Organisasi</th>
                <td style="font-weight: 700">:</th>
                <td class="uppercase" colspan="4">Kecamatan Martapura</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-weight: 700">Ruangan</th>
                <td style="font-weight: 700">:</th>
                <td style="width: 40%;">{{ $ruangan->nama_ruangan }}</td>
                <td style="font-weight: 700; width: 80px">No. Kode Lokasi</td>
                <td style="font-weight: 700; width: 10px">:</th>
                <td class="uppercase" style="width: 100px">12.01.25.01.04.06.01.01.2004</td>
            </tr>
        </table>
